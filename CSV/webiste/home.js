...
const Home = (props) => {
  return (
    <div className={styles['container']}>
      ...
      <img alt="image" src="/curved6-1500h.jpg" className={styles['image04']} />
      ...
      <section className={styles['testimonials']}>
        ...
        />
        <img alt="image" src="/waves-white.svg" className={styles['image19']} />
        <img alt="image" src="/top.svg" className={styles['top-wave-image']} />
      </section>
